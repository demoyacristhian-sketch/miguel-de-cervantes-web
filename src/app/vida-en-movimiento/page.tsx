    ...
    <div>
      <div className="mx-auto max-w-3xl px-6 pt-16 pb-10 text-center">
        ...
        <p className="mt-6 text-left text-foreground/80">
          ...
          Entre esas dos fechas: soldado en la batalla de Lepanto (1571), donde quedó manco de la
          mano izquierda; cinco años de cautiverio en Argel (1575–1580); su matrimonio con Catalina
          de Salazar en Esquivias (1584); una temporada en la cárcel de Sevilla (1597) por las
          cuentas de su oficio de recaudador de impuestos; y, ya instalado entre Valladolid y Madrid,
          la publicación de <em>Don Quijote de la Mancha</em> (1605), la obra que lo consagraría como
          el mayor escritor en lengua española.
        </p>
